<div id="menu-social-nav" class="menu">
	<a target="_blank" href="<?php the_field('email_link', 'option'); ?>"><span class="icon-envelope"></span></a>
	...
	<a target="_blank" href="<?php bloginfo('rss2_url'); ?>"><span class="icon-rss"></span></a>
</div>